const themeSeeds = {
  ...
  'manga:異世界': ['転生したらスライムだった件', '無職転生', 'この素晴らしい世界に祝福を！', 'オーバーロード', '盾の勇者の成り上がり', '異世界おじさん', 'とんでもスキルで異世界放浪メシ', '幼女戦記'],
  'manga:スポーツ': ['ハイキュー!!', 'ブルーロック', 'SLAM DUNK', 'メダリスト', 'アオアシ', 'ダイヤのA', '弱虫ペダル', 'はじめの一歩'],
  'manga:ホラー': ['光が死んだ夏', '見える子ちゃん', '裏バイト：逃亡禁止', '彼岸島', '不安の種', '伊藤潤二傑作集', '地獄先生ぬ〜べ〜', 'ミスミソウ'],
  'manga:完結漫画': ['鋼の錬金術師', 'ハイキュー!!', '鬼滅の刃', 'SLAM DUNK', '寄生獣', '四月は君の嘘', '約束のネバーランド', '暗殺教室'],
  'manga:一気読み漫画': ['約束のネバーランド', '僕だけがいない街', 'DEATH NOTE', '鬼滅の刃', '進撃の巨人', 'チェンソーマン', '寄生獣', 'サマータイムレンダ'],
  'manga:大学生漫画': ['ブルーピリオド', '3月のライオン', '宇宙兄弟', 'スキップとローファー', 'メダリスト', '左ききのエレン', '東京タラレバ娘', 'ハチミツとクローバー'],
  'manga:短編漫画': ['聲の形', 'ルックバック', 'さよなら絵梨', '惑星のさみだれ', '彼方のアストラ', 'ミスミソウ', 'ソラニン', 'レベルE'],
  ...
  'novel:SF': ['プロジェクト・ヘイル・メアリー', '三体', '新世界より', '星を継ぐもの', '1984年', '夏への扉', 'ハーモニー', '虐殺器官'],
  'novel:ホラー': ['近畿地方のある場所について', '夜市', '残穢', '黒い家', 'ぼぎわんが、来る', 'ぼっけえ、きょうてえ', 'リング', '営繕かるかや怪異譚'],
  'novel:歴史': ['燃えよ剣', '天地明察', '村上海賊の娘', '塞王の楯', '蜩ノ記', '一路', '八本目の槍', '峠'],
  'novel:寝る前小説': ['木曜日にはココアを', '阪急電車', '西の魔女が死んだ', 'ツバキ文具店', 'ライオンのおやつ', '神様のカルテ', '博士の愛した数式', 'お探し物は図書室まで'],
  'novel:一気読み小説': ['方舟', '六人の嘘つきな大学生', '変な家', '十角館の殺人', '容疑者Xの献身', '爆弾', 'medium 霊媒探偵城塚翡翠', '葉桜の季節に君を想うということ'],
  'novel:大学生小説': ['成瀬は天下を取りにいく', '夜のピクニック', '何者', 'コンビニ人間', '君の膵臓をたべたい', 'かがみの孤城', '夜は短し歩けよ乙女', '風が強く吹いている'],
  'novel:短編小説': ['ボッコちゃん', 'きまぐれロボット', '満願', '死神の精度', '夜市', '注文の多い料理店', '掌の小説', 'アイネクライネナハトムジーク'],
}
